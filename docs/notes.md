> These are the project's working notes: why each decision was made, what was
> tried and dropped, and what is verified on which system. The short
> presentation lives in [README.md](../README.md).
...
*Une version française de ce document est disponible dans [notes.fr.md](notes.fr.md).*
