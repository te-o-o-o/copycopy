> Ce sont les notes de travail du projet : pourquoi chaque décision a été prise,
> ce qui a été essayé puis abandonné, et ce qui est vérifié sur quel système. La
> présentation courte est dans [README.fr.md](../README.fr.md).
...
*An English version of this document is available in [notes.md](notes.md).*
